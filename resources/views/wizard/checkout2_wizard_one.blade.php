               ...
               <div class="checkout-progress-indicator px-15 content-center">
                  <div class="checkout-progress">
                     ...
                     <div class="step current" id="2">
                        <span> <img class="svg" src="{{ asset('img/svg/adress-active.svg')}} " alt=""> </span>
                           ...
                           <div class="edit-profile__body">
                              <form>
                                 ...
                                 <div class="button-group d-flex pt-10 mb-20 justify-content-between flex-wrap">
                                    <a href="{{ route('wizard.wizardOne') }}" class="btn btn-light btn-default btn-squared fw-400 text-capitalize m-1"><i class="las la-arrow-left mr-10"></i>Previous</a>
                                    <a href="{{ route('wizard.checkoutPaymentWizard6') }}" class="btn text-white btn-primary btn-default btn-squared text-capitalize m-1">Save & Next<i class="ml-10 mr-0 las la-arrow-right"></i></a>
                                </div>
                              </form>
                           </div>
                        </div>
