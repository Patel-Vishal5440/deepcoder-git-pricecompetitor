                       ...
                       <div class="col-xl-4">
                           <div class="checkout-progress-indicator">
                               ...
                               <div class="card-header border-bottom-0">
                                   ...
                                   <img class="svg" src="{{ asset('img/svg/progress4.svg') }}" alt="">
                               </div>
                           </div><!-- checkout -->
                       </div>
                       <div class="col-xl-7 col-lg-8 col-sm-10">
                           <div class="checkout-shipping-form pt-45 pr-0">
                               <h4 class="fw-500 checkout-review-title mb-50 mt-0">4. Review and confirm your order</h4>
                               ...
                               <div class="button-group d-flex pt-40 mb-xl-20  justify-content-sm-between justify-content-center m-0 mb-xl-30 mb-30 flex-wrap">
                                   <a href="{{ route('wizard.checkoutPaymentWizard8') }}" class="btn btn-light btn-default btn-squared fw-400 text-capitalize m-sm-0 m-1"><i class="las la-arrow-left mr-10"></i>Previous</a>
                                   <a href="{{ route('wizard.paymentStatusWizard8') }}" class="btn text-white btn-primary btn-default btn-squared text-capitalize m-sm-0 m-1">Save
                                       &
