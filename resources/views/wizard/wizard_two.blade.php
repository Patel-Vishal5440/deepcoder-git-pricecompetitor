                           ...
                           <div class="edit-profile__body">
                              <form>
                                 ...
                                 <div class="d-flex pt-15 justify-content-md-end justify-content-center">
                                    <a href="{{ route('wizard.checkout2Wizard7') }}" class="btn btn-primary btn-default btn-squared text-capitalize text-white">Save & Next<i class="ml-10 mr-0 las la-arrow-right"></i></a>
                                 </div>
                              </form>
                           </div>
                        </div>
