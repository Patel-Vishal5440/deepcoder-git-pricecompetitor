                   ...
                   <div class="row justify-content-center">
                       ...
                       <div class="col-lg-7">
                           ...
                           <div class="button-group d-flex pt-40 justify-content-between flex-wrap">
                               <a href="{{ route('wizard.checkout2Wizard9') }}" class="btn btn-light btn-default btn-squared fw-400 text-capitalize m-1"><i class="las la-arrow-left mr-10"></i>Previous</a>
                               <a href="{{ route('wizard.checkoutReviewWizard9') }}" class="btn text-white btn-primary btn-default btn-squared text-capitalize m-1">Save
