               ...
               <div class="checkout-progress-indicator content-center px-15">
                  <div class="checkout-progress">
                     ...
                     <div class="step current" id="3">
                        <span><img class="svg" src="{{ asset('img/svg/155-credit-card-active.svg') }}" alt=""></span>
               ...
               <div class="row justify-content-center">
                  <div class="col-xl-7 col-lg-8 col-sm-10">
                     ...
                     <div class="button-group d-flex pt-40 mb-xl-20  justify-content-sm-between justify-content-center m-0 mb-xl-30 mb-30 flex-wrap">
                        <a href="{{ route('wizard.checkout2WizardOne') }}" class="btn btn-light btn-default btn-squared fw-400 text-capitalize m-sm-0 m-1"><i class="las la-arrow-left mr-10"></i>Previous</a>
                        <a href="{{ route('wizard.checkoutReviewWizard6') }}" class="btn text-white btn-primary btn-default btn-squared text-capitalize m-sm-0 m-1">Save &
