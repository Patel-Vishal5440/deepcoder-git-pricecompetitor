                           ...
                           <div class="edit-profile__body">
                              <form>
                                 ...
                                 <div class="button-group d-flex pt-3 justify-content-between flex-wrap">
                                    ...
                                    <a href="{{ route('wizard.checkoutPaymentWizard7') }}" class="btn text-white btn-primary btn-default btn-squared text-capitalize m-1">Save & Next<i class="ml-10 mr-0 las la-arrow-right"></i></a>
                                 </div>
                              </form>
                           </div>
                        </div>
