...
<div class="contents">
   ...
   <div class="container-fluid">
      <div class=" global-shadow wizard6 checkout-review border py-30 px-sm-50 px-30 bg-white radius-xl w-100 mb-30">
               ...
               <div class="checkout-progress-indicator content-center">
                  <div class="checkout-progress w-100">
                     ...
                     <div class="step completed" id="4">
                        <span><img class="svg" src="{{ asset('img/svg/024-like-success.svg') }}" alt=""></span>
