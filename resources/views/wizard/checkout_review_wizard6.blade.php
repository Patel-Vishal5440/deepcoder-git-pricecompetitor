...
<div class="contents">
   ...
   <div class="container-fluid">
      <div class=" global-shadow wizard6 checkout-review border p-sm-50 p-20 mb-50 bg-white radius-xl w-100">
         <div class="row justify-content-center">
            <div class="cus-8 col-12">
               <div class="checkout-progress-indicator content-center">
                  <div class="checkout-progress w-100">
                     <div class="step completed" id="1">
                        <span> <img class="svg" src="{{ asset('img/svg/user-success.svg') }}" alt=""> </span>
                        <span>Create Account</span>
                     </div>
                     <div class="current"><img src="{{ asset('img/svg/green.svg') }}" alt="img" class="svg"></div>
                     <div class="step completed" id="2">
                        <span> <img class="svg" src="{{ asset('img/svg/address-success.svg') }}" alt=""> </span>
                        <span>Shipping Address</span>
                     </div>
                     <div class="current"><img src="{{ asset('img/svg/green.svg') }}" alt="img" class="svg"></div>
                     <div class="step completed" id="3">
                        <span><img class="svg" src="{{ asset('img/svg/155-credit-card-success.svg') }}" alt=""></span>
                        <span>Payment Method</span>
                     </div>
                     <div class="current"><img src="{{ asset('img/svg/checkoutin.svg') }}" alt="img" class="svg"></div>
                     <div class="step current" id="4">
                        <span><img class="svg" src="{{ asset('img/svg/024-like-active.svg') }}" alt=""></span>
               ...
               <div class="button-group d-flex pt-40 mb-xl-20  justify-content-sm-between justify-content-center m-0 mb-xl-30 mb-30 flex-wrap">
                  <a href="{{ route('wizard.checkoutPaymentWizard6') }}" class="btn btn-light btn-default btn-squared fw-400 text-capitalize m-sm-0 m-1"><i class="las la-arrow-left mr-10"></i>Previous</a>
                  <a href="{{ route('wizard.paymentStatusWizard6') }}" class="btn text-white btn-primary btn-default btn-squared text-capitalize m-sm-0 m-1">Save &
