                            ...
                            <div class="filtr-container">
                                <div class="filtr-item filtr-item--style" data-category="1" data-sort="Busy streets">
                                    <div class="card">
                                        <div class="gc gc--gallery2">
                                            <div class="gc__img">
                                                <img src="{{ asset('img/gallery.png') }}" alt="img" class="w-100 radius-xl">
                                            </div>
                                            <div class="card-body">
                                                <div class="gc__title">
                                                ...
                                                <ul class="gc__link">
                                                    <li><a href="#"><span data-feather="link"></span></a></li>
                                                    <li><a href="#"><span data-feather="search"></span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="filtr-item filtr-item--style" data-category="2" data-sort="Luminous night">
                                    <div class="card">
                                        <div class="gc gc--gallery2">
                                            <div class="gc__img">
                                                <img src="{{ asset('img/gallery2.png') }}" alt="img" class="w-100 radius-xl">
                                            </div>
                                            <div class="card-body">
                                                <div class="gc__title">
                                                    <P class="title">Snow covered mountain</P>
                                ...
                                <div class="filtr-item filtr-item--style" data-category="3" data-sort="City wonders">
                                    <div class="card">
                                        <div class="gc gc--gallery2">
                                            <div class="gc__img">
                                                <img src="{{ asset('img/gallery3.png') }}" alt="img" class="w-100 radius-xl">
                                            </div>
                                            <div class="card-body">
                                                <div class="gc__title">
                                                    <P class="title">Snow covered mountain</P>
                                ...
                                <div class="filtr-item filtr-item--style" data-category="4" data-sort="In production">
                                    <div class="card">
                                        <div class="gc gc--gallery2">
                                            <div class="gc__img">
                                                <img src="{{ asset('img/gallery4.png') }}" alt="img" class="w-100 radius-xl">
                                            </div>
                                            <div class="card-body">
                                                <div class="gc__title">
                                                    <P class="title">Snow covered mountain</P>
                                ...
                                <div class="filtr-item filtr-item--style" data-category="2" data-sort="Industrial site">
                                    <div class="card">
                                        ...
                                        <div class="gc gc--gallery2">
                                            <div class="gc__img">
                                                <img src="{{ asset('img/gallery5.png') }}" alt="img" class="w-100 radius-xl">
                                            </div>
                                            <div class="card-body">
                                                <div class="gc__title">
                                                    <P class="title">Snow covered mountain</P>
                                ...
                                <div class="filtr-item filtr-item--style" data-category="3" data-sort="Peaceful lake">
                                    <div class="card">
                                        <div class="gc gc--gallery2">
                                            <div class="gc__img">
                                                <img src="{{ asset('img/gallery6.png') }}" alt="img" class="w-100 radius-xl">
                                            </div>
                                            <div class="card-body">
                                                <div class="gc__title">
                                                    <P class="title">Snow covered mountain</P>
                                ...
                                <div class="filtr-item filtr-item--style" data-category="4" data-sort="Industrial site">
                                    <div class="card">
                                        <div class="gc gc--gallery2">
                                            <div class="gc__img">
                                                <img src="{{ asset('img/gallery7.png') }}" alt="img" class="w-100 radius-xl">
                                            </div>
                                            <div class="card-body">
                                                <div class="gc__title">
                                                    <P class="title">Snow covered mountain</P>
                                ...
                                <div class="filtr-item filtr-item--style" data-category="2" data-sort="Industrial site">
                                    <div class="card">
                                        <div class="gc gc--gallery2">
                                            <div class="gc__img">
                                                <img src="{{ asset('img/gallery8.png') }}" alt="img" class="w-100 radius-xl">
                                            </div>
                                            <div class="card-body">
                                                <div class="gc__title">
                                                    <P class="title">Snow covered mountain</P>
                                ...
                                <div class="filtr-item filtr-item--style" data-category="3" data-sort="Peaceful lake">
                                    <div class="card">
                                        <div class="gc gc--gallery2">
                                            <div class="gc__img">
                                                <img src="{{ asset('img/gallery9.png') }}" alt="img" class="w-100 radius-xl">
                                            </div>
                                            <div class="card-body">
                                                <div class="gc__title">
                                                    <P class="title">Snow covered mountain</P>
                                ...
                                <div class="filtr-item filtr-item--style" data-category="4" data-sort="Industrial site">
                                    <div class="card">
                                        <div class="gc gc--gallery2">
                                            <div class="gc__img">
                                                <img src="{{ asset('img/gallery10.png') }}" alt="img" class="w-100 radius-xl">
                                            </div>
                                            <div class="card-body">
                                                <div class="gc__title">
                                                    <P class="title">Snow covered mountain</P>
                                ...
                                <div class="filtr-item filtr-item--style" data-category="1" data-sort="Peaceful lake">
                                    <div class="card">
                                        <div class="gc gc--gallery2">
                                            <div class="gc__img">
                                                <img src="{{ asset('img/gallery11.png') }}" alt="img" class="w-100 radius-xl">
                                            </div>
                                            <div class="card-body">
                                                <div class="gc__title">
                                                    <P class="title">Snow covered mountain</P>
