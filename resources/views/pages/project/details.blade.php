         ...
         <div class="col-lg-12">
            <div class="breadcrumb-main application-ui mb-30">
               <div class="breadcrumb-action d-flex">
                  ...
                  <div class="action-btn mr-10 my-sm-0">
                     <a href="#" class="btn radius-md btn-primary bg-primary fs-12 fw-500"><span data-feather="plus"></span> Add
                     task</a>
                  </div>
               ...
               <div class="d-flex text-capitalize">
                  ...
                  <button type="button" class="breadcrumb-remove border-0 color-danger content-center bg-white fs-12 fw-500 ml-10 radius-md">
               ...
               <div class="progress-box px-25 pt-25 pb-10 bg-success radius-xl">
                  ...
                  <div class="progress-wrap d-flex align-items-center mb-15">
                     <div class="progress progress-height">
                        <div class="progress-bar bg-white" role="progressbar" style="width: 64%;" aria-valuenow="64" aria-valuemin="0" aria-valuemax="100"></div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="card-body">
                     ...
                     <div class="application-task d-flex align-items-center mb-25">
                        <div class="application-task-icon wh-60 bg-opacity-secondary content-center">
                           <img class="svg wh-25 text-secondary" src="{{ asset('img/svg/at2.svg') }}" alt="img">
                        </div>
                        <div class="application-task-content">
                           <h4>34</h4>
                  ...
                  <div class="col-xxl-4 col-lg-12 col-12 mb-25">
                     <div class="card h-100">
                        <div class="card-header d-flex justify-content-between align-items-center py-10  px-sm-25 px-3">
                           ...
                           <button type="button" class="border rounded-lg color-primary fw-500 fs-12 bg-transparent acButton">
                           <span data-feather="user-plus"></span> add user</button>
                        </div>
                        <div class="card-body">
                           <div class="d-flex align-items-center mb-25">
                              <img src="{{ asset('img/tm1.png') }}" class="wh-46 mr-15" alt="img">
                              <div>
                           ...
                           <div class="d-flex align-items-center mb-25">
                              <img src="{{ asset('img/tm2.png') }}" class="wh-46 mr-15" alt="img">
                              <div>
                           ...
                           <div class="d-flex align-items-center mb-25">
                              <img src="{{ asset('img/tm3.png') }}" class="wh-46 mr-15" alt="img">
                              <div>
                           ...
                           <div class="d-flex align-items-center mb-25">
                              <img src="{{ asset('img/tm4.png') }}" class="wh-46 mr-15" alt="img">
                              <div>
                           ...
                           <div class="d-flex align-items-center">
                              <img src="{{ asset('img/tm5.png') }}" class="wh-46 mr-15" alt="img">
                              <div>
               ...
               <div class="card">
                  <div class="card-header p-0">
                     <ul class="nav px-25 ap-tab-main app-ui-tab" id="project-ap-tab" role="tablist">
                        <li class="nav-item">
                           <a class="nav-link active" id="project-overview-tab" data-toggle="pill" href="#project-overview" role="tab" aria-controls="project-overview" aria-selected="true">task list</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" id="project-timeline-tab" data-toggle="pill" href="#project-timeline" role="tab" aria-controls="project-timeline" aria-selected="false">Activities</a>
                        </li>
                     </ul>
                  </div>
                                       ...
                                       <td>
                                          <div class="checkbox-group d-flex">
                                             <div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                ...
                                                <label for="check-grp-4" class="fs-14 color-light strikethrough">
                                       ...
                                       <td>
                                          <div class="checkbox-group d-flex">
                                             <div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                ...
                                                <label for="check-grp-5" class="fs-14 color-light strikethrough">
                                       ...
                                       <td>
                                          <div class="checkbox-group d-flex">
                                             <div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                ...
                                                <label for="check-grp-6" class="fs-14 color-light strikethrough">
                                       ...
                                       <td>
                                          <div class="checkbox-group d-flex">
                                             <div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                ...
                                                <label for="check-grp-7" class="fs-14 color-light strikethrough">
                        ...
                        <div class="card-body px-0 mx-25 border-bottom">
                           <div class="task-activities d-flex align-items-center">
                              <div class="task-activities__left d-flex">
                                 <div class="content-center border bg-normal radius-xl mr-sm-20 mr-0 task-activities__month">
                                    ...
                                    <ul>
                                          ...
                                          <div class="ffp d-flex justify-content-between align-items-center w-100">
                                             <div class="d-flex">
                                                <div class="mr-3 ffp__imgWrapper d-flex align-items-center ">
                                                   <span class=" wh-24 mr-15 rounded-circle content-center color-danger bg-opacity-danger">
                                                   <span data-feather="plus"></span></span>
                                                   <span class="profile-image rounded-circle d-block wh-34 m-0 " style="background-image:url('{{ asset('img/tm5.png') }}'); background-size: cover;"></span>
                                                </div>
                                                <div>
                                                   <a href="#">
                                       ...
                                       <li class="">
                                          <div class="ffp d-flex justify-content-between align-items-center w-100">
                                             <div class="d-flex">
                                                <div class="mr-3 ffp__imgWrapper d-flex align-items-center ">
                                                   <span class=" wh-24 mr-15 rounded-circle content-center color-primary bg-opacity-primary">
                                                   <span data-feather="code"></span></span>
                                                   <span class="profile-image rounded-circle d-block wh-34 m-0 " style="background-image:url('{{ asset('img/tm6.png') }}'); background-size: cover;"></span>
                                                </div>
                                                <div>
                                                   <a href="#">
                                       ...
                                       <li class="">
                                          <div class="ffp d-flex justify-content-between align-items-center w-100">
                                             <div class="d-flex">
                                                <div class="mr-3 ffp__imgWrapper d-flex align-items-center ">
                                                   <span class=" wh-24 mr-15 rounded-circle content-center color-success bg-opacity-success">
                                                   <span data-feather="check"></span></span>
                                                   <span class="profile-image rounded-circle d-block wh-34 m-0 " style="background-image:url('{{ asset('img/tm2.png') }}'); background-size: cover;"></span>
                                                </div>
                                                <div>
                                                   <a href="#">
                                    ...
                                    <ul>
                                       <li class="">
                                          <div class="ffp d-flex justify-content-between align-items-center w-100">
                                             <div class="d-flex">
                                                <div class="mr-3 ffp__imgWrapper d-flex align-items-center ">
                                                   <span class=" wh-24 mr-15 rounded-circle content-center color-info bg-opacity-info">
                                                   <span data-feather="user-plus"></span></span>
                                                   <span class="profile-image rounded-circle d-block wh-34 m-0 " style="background-image:url('{{ asset('img/tm2.png') }}'); background-size: cover;"></span>
                                                </div>
                                                <div>
                                                   <a href="#">
                                          ...
                                          <div class="ffp d-flex justify-content-between align-items-center w-100">
                                             <div class="d-flex">
                                                <div class="mr-3 ffp__imgWrapper d-flex align-items-center ">
                                                   <span class=" wh-24 mr-15 rounded-circle content-center color-primary bg-opacity-primary">
                                                   <span data-feather="code"></span></span>
                                                   <span class="profile-image rounded-circle d-block wh-34 m-0 " style="background-image:url('{{ asset('img/tm3.png') }}'); background-size: cover;"></span>
                                                </div>
                                                <div>
                                                   <a href="#">
                                                      <p class="fw-500 fs-14 text-dark mb-0">Mike Greene
                                       ...
                                       <li class="">
                                          <div class="ffp d-flex justify-content-between align-items-center w-100">
                                             <div class="d-flex">
                                                <div class="mr-3 ffp__imgWrapper d-flex align-items-center ">
                                                   <span class=" wh-24 mr-15 rounded-circle content-center color-warning bg-opacity-warning">
                                                   <span data-feather="upload"></span></span>
                                                   <span class="profile-image rounded-circle d-block wh-34 m-0 " style="background-image:url('{{ asset('img/tm4.png') }}'); background-size: cover;"></span>
                                                </div>
                                                <div>
                                                   <a href="#">
                                                      <p class="fw-500 fs-14 text-dark mb-0">Tomlinson
