                                    ...
                                    <div class="project-icon-selected">
                                       <div class="listing-social-link pb-lg-0 pb-xs-2">
                                          <div class="icon-list-social d-flex">
                                             <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center ml-xl-20 mr-20  " href="{{ route("pages.fileManager") }}">
                                             <span data-feather="grid"></span></a>
                                             <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center  active" href="#">
                                          ...
                                          <tbody>
                                                ...
                                                <td>
                                                   <div class="files-area__left d-flex align-items-center">
                                                      <div class="files-area__img">
                                                         <img src="{{ asset('img/pdf.png') }}" alt="img" class="wh-40">
                                                      </div>
                                             ...
                                             <tr>
                                                <td>
                                                   <div class="files-area__left d-flex align-items-center">
                                                      <div class="files-area__img">
                                                         <img src="{{ asset('img/zip.png') }}" alt="img" class="wh-40">
                                                      </div>
                                                      <div class="files-area__title">
                                             ...
                                             <tr>
                                                <td>
                                                   <div class="files-area__left d-flex align-items-center">
                                                      <div class="files-area__img">
                                                         <img src="{{ asset('img/psd.png') }}" alt="img" class="wh-40">
                                                      </div>
                                                      <div class="files-area__title">
