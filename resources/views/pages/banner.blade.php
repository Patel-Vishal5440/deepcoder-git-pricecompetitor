         ...
         <div class="row">
            ...
            <div class="col-xxl-3 col-sm-6">
               <div class="card banner-feature banner-feature--2">
                  <div class="banner-feature__shape">
                     <img src="{{ asset('img/svg/group9010.svg') }}" alt="img" class="svg">
                  </div>
            ...
            <div class="col-xxl-3 col-sm-6">
               <div class="card banner-feature banner-feature--3">
                  <div class="banner-feature__shape">
                     <img src="{{ asset('img/svg/group9060.svg') }}" alt="img" class="svg">
                  </div>
                  <div class="d-flex justify-content-center">
                     <div class="card-body">
            ...
            <div class="col-xxl-3 col-sm-6">
               <div class="card banner-feature banner-feature--4">
                  <div class="banner-feature__shape">
                     <img src="{{ asset('img/svg/group3503.svg') }}" alt="img" class="svg">
                  </div>
                  <div class="d-flex justify-content-center">
                     <div class="card-body">
            ...
            <div class="col-xxl-4 col-sm-6">
               <div class="card banner-feature banner-feature--5">
                  <div class="banner-feature__shape">
                     <img src="{{ asset('img/svg/group3320.svg') }}" alt="img" class="svg">
                  </div>
                  <div class="d-flex justify-content-center">
                     <div class="card-body">
            ...
            <div class="col-xxl-4 col-sm-6">
               <div class="card banner-feature banner-feature--6">
                  <div class="d-flex justify-content-center">
                     <div class="card-body">
                        <img src="{{ asset('img/sale.png') }}" alt="img" class="svg">
            ...
            <div class="col-xxl-4 col-sm-6">
               <div class="card banner-feature banner-feature--7">
                  <div class="d-flex justify-content-center">
                     <div class="card-body">
                        <div class="banner-feature__shape mr-20">
                           <img src="{{ asset('img/svg/group9102.svg') }}" alt="img" class="svg">
                        </div>
                        <div class="div">
                              ...
                              <div class="d-flex w-100">
                                 <div class="card-body">
                                    <div class="banner-feature__shape mb-30 content-center">
                                       <img src="{{ asset('img/svg/group3488.svg') }}" alt="img" class="svg">
                                    </div>
                     ...
                     <div class="card banner-feature--9">
                        <div class="card-body">
                           ...
                           <div class="banner-feature__shape mt-30">
                              <img src="{{ asset('img/svg/group3396.svg') }}" alt="img" class="svg">
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-md-6 mb-25">
                     <div class="card  banner-feature--10">
                        <div class="banner-feature__shape">
                           <img src="{{ asset('img/svg/group93352.svg') }}" alt="img" class="svg w-100">
                        </div>
                        <div class="d-flex justify-content-center">
                           <div class="card-body">
                  ...
                  <div class="col-md-6">
                     <div class="card banner-feature--11">
                        <div class="banner-feature__shape">
                           <img src="{{ asset('img/svg/man.svg') }}" alt="img" class="svg">
                        </div>
                        <div class="d-flex justify-content-center">
                           <div class="card-body">
            ...
            <div class="col-lg-6 mb-xxl-45 mb-25">
               <div class="card banner-feature--12 d-flex">
                  <div class="d-flex flex-sm-nowrap flex-wrap align-items-center text-center">
                     <div class="banner-feature__shape">
                        <img src="{{ asset('img/svg/group3474.svg') }}" alt="img" class="svg">
                     </div>
                     <div class="card-body">
            ...
            <div class="col-lg-6 mb-xxl-45 mb-25">
               <div class="card banner-feature--13 d-flex">
                  <div class="d-flex align-items-center flex-sm-nowrap flex-wrap text-sm-left text-center">
                     ...
                     <div class="banner-feature__shape">
                        <img src="{{ asset('img/svg/objects.svg') }}" alt="img" class="svg">
                     </div>
                  </div>
               </div>
            </div>
