                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-main">
                            <h4 class="text-capitalize breadcrumb-title">Google Maps</h4>
...
{{-- Scripts Section --}}
@section('mapScript')
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAHLfU1XLPHOHipNjcJAe2xRmmMHcYohHY" async defer></script>
@endsection
