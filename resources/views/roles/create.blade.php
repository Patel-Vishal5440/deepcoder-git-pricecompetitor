    ...
    <div class="col-lg-8 col-md-10 col-12 mx-auto my-4">
        <div class="card shadow-sm">
            <div class="card-body p-4">
                <h4 class="mb-4">{{ isset($role) ? 'Edit Role' : 'Create Role' }}</h4>
                ...
                <form id="roleForm" action="{{ isset($role) ? route('roles.update', $role) : route('roles.store') }}" method="POST" novalidate>
                    @csrf
                    @if(isset($role))
                        @method('PUT')
                    @endif
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="invalid-feedback" id="name-error">
                                @error('name')
                                    {{ $message }}
                                @else
                                    Please enter a valid role name (3-255 characters, letters, numbers, spaces, dots, underscores, hyphens only)
                                @enderror
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateName() {
        ...
        if (!patterns.name.test(value)) {
            showError(nameInput, 'Role name can only contain letters, numbers, spaces, dots, underscores, and hyphens');
            return false;
        }
    ...
    window.testRoleValidation = function() {
        ...
        console.log('Permissions checked:', document.querySelectorAll('.permission-checkbox:checked').length);
